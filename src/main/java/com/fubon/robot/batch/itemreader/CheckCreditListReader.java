...
@StepScope
@Transactional
public class CheckCreditListReader extends StepExecutionListenerSupport implements ItemReader<TBusCustomer> {
	...
	public void beforeStep(StepExecution stepExecution) {
		...
		evoiceInputDatas = (ReadListDTO) stepExecution.getJobExecution().getExecutionContext()
				.get(RederListJobConfig.JOB_EXECUTION_EVOICE_DATA_RESULT);
